    ...
    <div className="footer-container maxwidth">
      <div className="footer-contact dflexc">
        ...
        <div className="contact-info">
          <img src="/assets/footer/icons/icon-1.png" alt="location" />
          <p><a href="">341 Londonderry Road, <br />Istanbul Türkiye</a></p>
        </div>
        <div className="contact-info">
          <img src="/assets/footer/icons/icon-2.png" alt="envelope" />
          <p><a href="">aciktim@teknolojikyemekler.com</a></p>
        </div>
        <div className="contact-info">
          <img src="/assets/footer/icons/icon-3.png" alt="phone" />
      ...
      <div className="footer-instagram dflexc">
        ...
        <div className="insta-grid">
          ...
          <img src="/assets/footer/other/footer-5.png" alt="" />
          <img src="/assets/footer/other/footer-6.png" alt="" />
        </div>
      </div>
    </div>
